...
## Project Structure
    ...
    ├── testdefreffe_dev_44369  # Django project configurations
...
1. Clone this repo and `cd testdefreffe_dev_44369`
...
2. Clone this repo and `cd testdefreffe_dev_44369`
